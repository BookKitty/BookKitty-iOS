...
public class Headline2Label: UILabel {
...
extension Headline2Label {
    ...
    private func getFontForWeight(_ weight: FontWeight) -> UIFont {
        switch weight {
        case .regular:
            return Fonts.headline2Regular
        case .semiBold:
            return Fonts.headline2SemiBold
        case .extraBold:
            return Fonts.headline2ExtraBold
        }
    }
}
